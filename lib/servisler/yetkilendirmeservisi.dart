...
class YetkilendirmeServisi {
  ...
  String?
      aktifKullaniciId; //aktif olan kullanıcıya her yerden erişebilimek için ekledik(provcider)
  ...
  Future<Kullanici?> mailIleKayit(String eposta, String sifre) async {
    UserCredential girisKarti = await _firebaseAuth
  ...
  Future<Kullanici?> mailIleGiris(String eposta, String sifre) async {
    UserCredential girisKarti = await _firebaseAuth.signInWithEmailAndPassword(
